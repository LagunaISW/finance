...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create finance-c84b
  fly apps create finance-c84b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app finance-c84b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app finance-c84b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'finance-c84b-staging' does not match app name in config file 'finance-c84b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name finance-c84b-db
  fly postgres attach --app finance-c84b finance-c84b-db

  fly postgres create --name finance-c84b-staging-db
  fly postgres attach --app finance-c84b-staging finance-c84b-staging-db
  ```
